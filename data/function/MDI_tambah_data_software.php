...
if (strlen($_POST['nama_software']) < 4 OR strlen($_POST['deskripsi_software']) < 4) { 
	header("Location:../data_software_mdi_form_tambah_data.php?status_error_data=error"); 
} 
else{ 
//simpan data ke database
$query = mysql_query("insert into data_software_mdi values('', '$nama_software', '$tanggal_software', '$status_software', 
	'$deskripsi_software')")or die(mysql_error());


if ($query) {
   header("Location:../data_software_mdi_form_tambah_data.php?status_tambah_data=success");
}
