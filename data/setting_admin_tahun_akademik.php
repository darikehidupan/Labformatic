...
<!-- Begin
var scrl = "Admin - Setting tahun akademik - Labformatic || ";
function scrlsts() {
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">			
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li class="active"><a href="setting_admin_tahun_akademik.php">Setting Tahun Akademik</a></li>
	...
	<div class="col-md-2 sidebar">
     <ul class="nav nav-pills nav-stacked">
       <li ><a href="home.php">Homepage</a></li>
        ...
        <p style="font-family: Roboto; font-size: 20px;">Set Tahun Akademik</p>  
    <div class="row grid-divider">
      <div class="col-sm-7">
       <div class="col-padding">
        ...
        <?php
          if (!empty($_GET['status_update_tahun_akademik']) && $_GET['status_update_tahun_akademik'] == 'success'){
          echo '
            <div class="alert alert-success" id="success-alert" role="alert">
            Berhasil Mengupdate Tahun Akademik
            </div>';
          }
          ?>
       <form name="Tambah_Username_Admin" action="function/manage_admin_update_kurikulum.php" method="post">
        ...
        <tr>
             ...
             <tr>
              <td>Semester</td>
                <td>
                <input size="25px" name="semester" type="text" list="semester" 
                placeholder="Masukan Semester" required 
                value="<?php echo $buff['semester']; ?>"/>
                </td>
