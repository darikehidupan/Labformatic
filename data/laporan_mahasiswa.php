...
<!-- Begin
var scrl = "Data Laporan Kepuasan Mahasiswa - Labformatic || ";
function scrlsts() {
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          echo '
            ...
            Berhasil Menghapus Data Laporan Mahasiswa
            </div>';
          }
          ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Rekap Laporan dari Mahasiswa - ||
                      <?php
                            ...
                            <div class="table-responsive">
                                <table class="display" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <tr>
                        <th width="2%">NPM / Nama Mahasiswa</th>
                        <th width="2%">Tanggal diterima</th>
                        <th width="2%">Lab Praktikum</th>
                        <th width="2%">Tingkat Kepuasan</th>
                        <th width="5%">Isi Feedback / Saran</th>
						<th width="8%">Aksi</th>
                    </tr>
                                    </thead>
                    ...
                    $sql = mysql_query('SELECT * FROM laporan_keluhan');
                    $no = 1;
                    ...
                    <tr align='left'>
                        <td><?php echo  $r['nama_npm'];?></td>
                        <td><?php echo  $r['Tanggal']; ?></td>
						            <td><?php echo  $r['lab']; ?></td>
                        <td><?php echo  $r['status']; ?></td>
                        <td>
                        <textarea><?php echo  $r['keluhan']; ?></textarea>    
                        </td>
                        <td>
                            <a href="laporan_mahasiswa_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> |             
							              <a href="function/laporan_mahasiswa_hapus.php?id3=<?php echo $r['id'];?>&status=<?php echo  $r['status'];?>"
