...
<!-- Begin
var scrl = "Lihat Data Arsip - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_arsip where id='$id1'";
	...
	<div class="container-fluid main-container">
      ...
      <?php include 'include_css/sidebar_link_dataarsip.php'; ?>
        ...
        <div class="panel panel-default">
                ...
                <strong>Arsip Lab Praktikum Universitas Yarsi - Form Lihat Data Arsip</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_arsip">
                <input type="hidden" name="id" value="<?php echo $id1; ?>" />
        <table class="table table-striped table-bordered table-hover">
        <tr>
              <td>Tahun</td>
                <td>
                <input name="Tahun" type="text" placeholder="Masukan Tahun Arsip" readonly="readonly"
                  value="<?php echo $buff['Tahun']; ?>">
                </td>
            </tr>
            <tr>
              <td>Bulan</td>
                ...
                placeholder="Masukan Data Bulan Arsip" readonly="readonly"
                  value="<?php echo $buff['Bulan']; ?>">
                </td>
                <datalist id="Bulan">
            ...
            <tr>
            <td>File yang telah di upload</td>
            <td>
               <input type="text" readonly="readonly"
                  value="<?php echo $buff['nama_file']; ?>">
                   <a href="function/arsip_downloadfile.php?file=<?php echo $buff['nama_file'];?>">Download file ini</a>
            </td>
            </tr>
            <tr>
              <td>Nama Uploader</td>
                <td>
                <input name="nama_uploader" type="text" placeholder="Masukan Nama Uploader"
                  readonly="readonly"
                  value="<?php echo $buff['nama_uploader']; ?>">
                </td>
            </tr>
            <tr>
              <td>Kategori</td>
                <td>
                <input name="kategori" type="text" placeholder="Masukan Kategori" 
                  readonly="readonly"
                  value="<?php echo $buff['kategori']; ?>">
                </td>
            </tr>
            <tr>
            <td>&nbsp;</td>
