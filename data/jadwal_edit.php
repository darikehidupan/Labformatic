...
<!-- Begin
var scrl = "Edit Data Jadwal - Labformatic || ";
function scrlsts() {
...
$query = "select * from jadwal where id='$id2'";
      ...
      <?php include 'include_css/sidebar_link_datajadwal.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <div class="panel panel-default">
                ...
                <strong>Jadwal Mata Kuliah - Form Edit Data Jadwal - <br/>
                <span class="glyphicon glyphicon-info-sign" style="color: red"></span>
                 Jika akan di lakukan editing hari , lebih baik di hapus terlebih dahulu lalu di tambahkan ulang </strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_jadwal" action="function/jadwal_edit_data.php" method="post">
       ...
       <tr>
              <td>Hari</td>
                ...
                placeholder="Masukan Hari Mata Kuliah" value="<?php echo $buff['hari']; ?>" required />
                </td>
                <datalist id="hari">
            ...
            <td>
               <input size="29px" name="jam_mulai" type="text" 
            ...
            <td>
               <input size="29px" name="jam_selesai" type="text" 
            ...
            <td>
               <input size="29px" name="asdos" type="text" 
