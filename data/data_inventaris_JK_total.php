           ...
           <div class="row grid-divider">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Total Data Inventaris |||
                      <?php
                    ...
                    ?>
                                 ...
                                 <a style="float:right; color:blue" href="data_inventaris_JK.php">Rekap Satuan |</a>
                                 <a style="float:right; color:blue" href="function/jk_inventaris_total_expor.php">Export Data |</a>
                    ...
                    <div class="panel-body">
                        ...
                        <th width="7%">Terakhir Kali Diupdate</th>
                    ...
                    $sql = mysql_query('SELECT * FROM data_inventaris_JK_total');
                    $no = 1;
