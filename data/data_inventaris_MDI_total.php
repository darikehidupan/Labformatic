          ...
          <div class="row grid-divider">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Lab Praktikum Manajemen Data dan Informasi - Total Data Inventaris |||
                      <?php
                    ...
                    ?>
                                 ...
                                 <a style="float:right; color:blue" href="data_inventaris_MDI.php">Rekap Satuan |</a>
                                 <a style="float:right; color:blue" href="function/mdi_inventaris_total_expor.php">Export Data |</a>
                    ...
                    $sql = mysql_query('SELECT * FROM data_inventaris_MDI_total');
                    $no = 1;
