...
<!-- Begin
var scrl = "Edit Data Inventaris JKK - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_inventaris_jk where id='$id2'";
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <a href=""> 
            ...
            <?php
          if (!empty($_GET['status_edit_data']) && $_GET['status_edit_data'] == 'success'){
          echo '
            <div class="alert alert-success" id="success-alert" role="alert">
            Berhasil Mengedit Data Inventaris
            </div>';
          }
          ?>
          ...
          <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Form Edit Data Inventaris</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Edit_data_software" action="function/JK_edit_data_inventaris.php" method="post">
                <input type="hidden" name="id" value="<?php echo $id2; ?>" />
        <table class="table table-striped table-bordered table-hover">       
         <tr>
              <td width="20%">Nama Barang</td>
                <td>
                <input name="nama_barang" type="text" placeholder="Masukan Nama Barang"
                 value="<?php echo $buff['nama_barang']; ?>" />
                </td>
            </tr>
            <tr>
            <td>Tanggal</td>
            <td>
             <div class="input-group date form_date col-md-3" data-date="" data-date-format="dd-mm-yyyy"  data-link-format="dd-mm-yyyy">
                <input name="tanggal" size="25"  type="text" placeholder="Di Edit Pada Tanggal"
            ...
            <tr>
              <td>Jumlah</td>
                ...
                value="<?php echo $buff['jumlah']; ?>" />
                </td>
            </tr>
            <tr>
            <td>Keterangan</td>
            <td>
              <textarea cols="40" rows="8" name="keterangan" placeholder="Masukan Keterangan dari barang"><?php echo $buff['keterangan']; ?></textarea>
            </td>
          </tr>
