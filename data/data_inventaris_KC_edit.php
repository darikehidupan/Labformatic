...
<!-- Begin
var scrl = "Edit Data Inventaris KC - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_inventaris_KC where id='$id2'";
        ...
        <!--link homepage-->
         ...
         <a href="data_inventaris.php"> 
          ...
          <div class="panel panel-default">
                ...
                <strong>Labo Praktikum Komputasional Cerdas - Form Edit Data Inventaris</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Edit_data_inventaris" action="function/KC_edit_data_inventaris.php" method="post">
