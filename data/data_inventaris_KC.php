...
<!-- Begin
var scrl = "Data Inventaris KC - Labformatic || ";
function scrlsts() {
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <div class="row grid-divider">
            <div class="col-sm-1">
              <div class="col-padding">
                <a class="thumbnail" href="data_inventaris_KC.php">
              <img src="../img/programming icon_invent.png">
                </a>
              </div>
          </div>
          </div> 
          ...
          echo '
            ...
            Berhasil Menghapus Data Inventaris KC
            </div>';
          }
          ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                        <strong>Lab Praktikum Komputasional Cerdas - Data Inventaris |||
                      <?php
                    ...
                    ?>
                                ...
                                <a style="float:right; color:blue" href="data_inventaris_KC_form_tambah_data.php">Tambah Data |</a> 
                                <a style="float:right; color:blue" href="data_inventaris_KC_total.php">Total Data |</a>
                                <a style="float:right; color:blue" href="function/KC_inventaris_expor.php">Export Data |</a> 
                </div>
           ...
           <th width="7%">Tanggal</th>
                    ...
                    $sql = mysql_query('SELECT * FROM data_inventaris_kc');
                    $no = 1;
            ...
            <td><?php echo  $r['jumlah']; ?></td>
                        ...
                        <td>
                            <a href="data_inventaris_KC_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> | 
                            <a href="data_inventaris_KC_edit.php?id2=<?php echo $r['id'];?>">Edit</a> |
							              <a href="function/KC_delete_data_inventaris.php?id3=<?php echo $r['id'];?>&jumlah1=<?php echo  $r['jumlah']; ?>&nama_barang1=<?php echo $r['nama_barang']; ?>"
