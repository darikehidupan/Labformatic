...
<!-- Begin
var scrl = "Edit Data Software KC - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_software_KC where id='$id2'";
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Komputasional Cerdas - Form Edit Data Software</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_software" action="function/KC_edit_data_software.php" method="post">
