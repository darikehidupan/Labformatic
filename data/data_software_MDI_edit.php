...
<!-- Begin
var scrl = "Edit Data Software MDI - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_software_mdi where id='$id2'";
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Manejemen Data dan Informasi - Form Edit Data Software</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_software" action="function/MDI_edit_data_software.php" method="post">
