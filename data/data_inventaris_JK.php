...
<!-- Begin
var scrl = "Data Inventaris JKK - Labformatic || ";
function scrlsts() {
        ...
        <!--link homepage-->
           ...
           <div class="row grid-divider">
            <div class="col-sm-1">
              <div class="col-padding">
                <a class="thumbnail" href="data_inventaris_JK.php">
              <img src="../img/networking icon_invent.png">
                </a>
              </div>
          </div>
          </div> 
         ...
         <?php
          ...
          echo '
            ...
            Berhasil Menghapus Data Inventaris JK
            </div>';
          }
          ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Data Inventaris |||
                      <?php
                    ...
                    ?>
                                ...
                                <a style="float:right; color:blue" href="data_inventaris_JK_form_tambah_data.php">Tambah Data |</a>  
                                <a style="float:right; color:blue" href="data_inventaris_JK_total.php">Total Data |</a>
                                <a style="float:right; color:blue" href="function/jk_inventaris_expor.php">Export Data |</a>
            ...
            <th width="7%">Tanggal</th>
                    ...
                    $sql = mysql_query('SELECT * FROM data_inventaris_JK');
                    $no = 1;
                    ...
                    <tr align='left'>
                        ...
                        <td>
                            <a href="data_inventaris_JK_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> | 
                            <a href="data_inventaris_JK_edit.php?id2=<?php echo $r['id'];?>">Edit</a> |
							              <a href="function/JK_delete_data_inventaris.php?id3=<?php echo $r['id'];?>&jumlah1=<?php echo  $r['jumlah']; ?>&nama_barang1=<?php echo $r['nama_barang']; ?>"
