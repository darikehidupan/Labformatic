...
<!-- Begin
var scrl = "Edit Data Inventaris MDI - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_inventaris_MDI where id='$id2'";
        ...
        <!--link homepage-->
         ...
         <a href="data_inventaris.php"> 
          ...
          <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Data dan Informasi - Form Edit Data Inventaris</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Edit_data_inventaris" action="function/MDI_edit_data_inventaris.php" method="post">
