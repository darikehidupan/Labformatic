...
<!-- Begin
var scrl = "Edit Data Software JKK - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_software_jk where id='$id2'";
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Form Edit Data Software</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Edit_data_software" action="function/JK_edit_data_software.php" method="post">
        ...
        <tr>
             ...
             <tr>
              <td>Tanggal Instalasi Software</td>
                <td>
                <input name="tanggal_software" type="date" placeholder="Masukan Tanggal Instalasi"  required="required" value="<?php echo $buff['tanggal_software']; ?>"/>
                </td>
            </tr>
            <tr>
              <td>Status Software</td>
                ...
                placeholder="Masukan Status Software" required value="<?php echo $buff['status_software']; ?>" />
                </td>
            ...
            <td>
              <textarea cols="40" rows="8" name="deskripsi_software" placeholder="Masukan Deskripsi dari Software"><?php echo $buff['deskripsi_software']; ?></textarea>
            </td>
          </tr>
