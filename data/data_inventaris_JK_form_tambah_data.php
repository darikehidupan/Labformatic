     ...
     <?php include 'include_css/sidebar_link_datainventaris.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <span>/</span>
          <a href="data_inventaris_JK_form_tambah_data.php"> 
              Tambah Data
          </a>
            </div>
          ...
          echo '
            ...
            Berhasil Menambah Data Inventaris JK
            </div>';
          }
          ?>
        ...
        <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Form Tambah Data Inventaris</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_inventaris" action="function/JK_tambah_data_inventaris.php" method="post">
