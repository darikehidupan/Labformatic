...
<!-- Begin
var scrl = "Data Software JKK - Labformatic || ";
function scrlsts() {
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          echo '
            ...
            Berhasil Menghapus Data Software JK
            </div>';
          }
          ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                      <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Data Software |||
                      <?php
                    ...
                    ?>
                                ...
                                <a style="float:right; color:blue" href="data_software_JK_form_tambah_data.php">Tambah Data |</a> 
                         
                                <a style="float:right; color:blue" href="function/jk_software_expor.php">Export Data |</a>
                </div>
                    ...
                    $sql = mysql_query('SELECT * FROM data_software_jk');
                    $no = 1;
                    ...
                    <tr align='left'>
                        ...
                        <td>
                            <a href="data_software_JK_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> | 
                            <a href="data_software_JK_edit.php?id2=<?php echo $r['id'];?>">Edit</a> |
						              	<a href="function/JK_delete_data_software.php?id3=<?php echo $r['id'];?>"
