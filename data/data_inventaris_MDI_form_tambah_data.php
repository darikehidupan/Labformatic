...
<!-- Begin
var scrl = "Tambah Data Inventaris MDI - Labformatic || ";
function scrlsts() {
     ...
     <?php include 'include_css/sidebar_link_datainventaris.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <span>/</span>
          <a href="data_inventaris_MDI_form_tambah_data.php"> 
              Tambah Data
          </a>
            </div>
          ...
          echo '
            ...
            Berhasil Menambah Data Inventaris MDI
            </div>';
          }
          ?>
        ...
        <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Manajemen Data dan Informasi - Form Tambah Data Inventaris</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_inventaris" action="function/MDI_tambah_data_inventaris.php" method="post">
