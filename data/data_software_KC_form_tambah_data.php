...
<!-- Begin
var scrl = "Tambah Data Software KC - Labformatic || ";
function scrlsts() {
     ...
     <?php include 'include_css/sidebar_link_datasoftware.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <span>/</span>
          <a href="data_software_KC_form_tambah_data.php"> 
              Tambah Data
          </a>
            </div>
         ...
         <?php
          ...
          echo '
            ...
            Berhasil Menambah Data Software KC
            </div>';
          }
          ?>   
        ...
        <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Komputasional Cerdas - Form Tambah Data Software</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_software" action="function/KC_tambah_data_software.php" method="post">
