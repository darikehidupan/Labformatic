         ...
         <!--link homepage-->
          ...
          <div class="row grid-divider">
            <div class="col-sm-1">
              ...
              <img src="../img/Time-Machine-icon.png">
                </a>
              </div>
          </div>
          </div>   
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    ?>
                                ...
                                <a style="float:right; color:blue" href="jadwal_form_tambah_data.php">Tambah Data |</a>  
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="display" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <th width="">Dosen Pengajar</th>
                                        <th width="">Jam Mulai</th>
                                        <th width="">Jam Selesai</th>
						                            <th width="">Lokasi Lab</th>
                                        <th width="">Aksi</th>
                    </tr>
                                    </thead>
                    ...
                    <tr align='left'>
                        ...
                        <td><?php echo  $r['laboratorium']; ?></td>
                        <td>
                            <a href="jadwal_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> | 
                            <a href="jadwal_edit.php?id2=<?php echo $r['id'];?>">Edit</a> |
							               <a href="function/jadwal_delete_data.php?id3=<?php echo $r['id'];?>&hari=<?php echo  $r['hari'];?>"
