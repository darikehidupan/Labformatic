...
<!-- Begin
var scrl = "Data Inventaris MDI - Labformatic || ";
function scrlsts() {
     ...
     <?php include 'include_css/sidebar_link_datainventaris.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <span>/</span>
          <a href="data_inventaris_MDI.php"> 
              MDI
          </a>
          </div>
          <div class="row grid-divider">
            <div class="col-sm-1">
              <div class="col-padding">
                <a class="thumbnail" href="data_inventaris_MDI.php">
              <img src="../img/database-icon_invent.png">
                </a>
              </div>
          </div>
          </div> 
          ...
          echo '
            ...
            Berhasil Menghapus Data Inventaris MDI
            </div>';
          }
          ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Lab Praktikum Manajemen Data dan Informasi - Data Inventaris |||
                      <?php
                    ...
                    ?>
                                ...
                                <a style="float:right; color:blue" href="data_inventaris_MDI_form_tambah_data.php">Tambah Data |</a> 
                                <a style="float:right; color:blue" href="data_inventaris_MDI_total.php">Total Data |</a> 
                                <a style="float:right; color:blue" href="function/MDI_inventaris_expor.php">Export Data |</a> 
           ...
           <th width="7%">Tanggal</th>
                    ...
                    $sql = mysql_query('SELECT * FROM data_inventaris_mdi');
                    $no = 1;
            ...
            <td><?php echo  $r['jumlah']; ?></td>
                        ...
                        <td>
                            <a href="data_inventaris_MDI_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> | 
                            <a href="data_inventaris_MDI_edit.php?id2=<?php echo $r['id'];?>">Edit</a> |
						                <a href="function/MDI_delete_data_inventaris.php?id3=<?php echo $r['id'];?>&jumlah1=<?php echo  $r['jumlah']; ?>&nama_barang1=<?php echo $r['nama_barang']; ?>"
