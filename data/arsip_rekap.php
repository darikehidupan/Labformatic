         ...
         <!--link homepage-->
          ...
          ?>
            ...
            <div class="panel panel-default">
                ...
                <strong>Rekapan Data Arsip FTI Universitas Yarsi
                    </strong>
                                <a style="float:right; color:blue" href="arsip_tambah_data.php">Tambah Data |</a>  
                </div>
                  ...
                  <tbody>
                    ...
                    $sql = mysql_query("SELECT * FROM data_arsip");
                    $no = 1;
                    ...
                    <tr align='left'>
                      ...
                      <a href="function/arsip_hapus.php?id3=<?php echo $r['id'];?>"
