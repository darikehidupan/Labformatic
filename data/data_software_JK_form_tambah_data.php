...
<!-- Begin
var scrl = "Tambah Data Software JKK - Labformatic || ";
function scrlsts() {
     ...
     <?php include 'include_css/sidebar_link_datasoftware.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <span>/</span>
          <a href="data_software_JK_form_tambah_data.php"> 
              Tambah Data
          </a>
            </div>
          ...
          echo '
            ...
            Berhasil Menambah Data Software JK
            </div>
            ';
          }
          ?>
        ...
        <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Form Tambah Data Software</strong>
                </div>
                <div class="panel-body">
                <!--Form Input Tambah Data Software-->
                <form name="Tambah_data_software" action="function/JK_tambah_data_software.php" method="post">
