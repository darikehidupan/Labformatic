...
<!-- Begin
var scrl = "Lihat Data Inventaris JKK - Labformatic || ";
function scrlsts() {
...
$query = "select * from data_inventaris_JK where id='$id1'";
     ...
     <?php include 'include_css/sidebar_link_datainventaris.php'; ?>
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          <div class="panel panel-default">
                ...
                <strong>Lab Praktikum Jaringan Komputer dan Komunikasi - Form Lihat Data Software</strong>
                </div>
        ...
        <table class="table table-striped table-bordered table-hover">
            <tr>
              <td>Nama Barang</td>
                <td>
                <input name="nama_barang" type="text" placeholder="Masukan Nama Barang" readonly="readonly"
            ...
            <tr>
              <td>Merk</td>
                <td>
                <input name="merk" type="text" placeholder="Masukan Merk Barang" readonly="readonly" 
            ...
            <tr>
              <td>Jumlah</td>
                <td>
                <input name="jumlah" type="text" placeholder="Masukan Jumlah Barang" readonly="readonly" 
            ...
            <td>Keterangan</td>
            <td>
              <textarea cols="40" rows="8" name="keterangan" placeholder="Masukan Keterangan dari barang" readonly="readonly"><?php echo $buff['keterangan']; ?></textarea>
            </td>
          </tr>
