...
<!-- Begin
var scrl = "Data Software KC - Labformatic || ";
function scrlsts() {
        ...
        <!--link homepage-->
         <!--link homepage-->
          ...
          echo '
            ...
            Berhasil Menghapus Data Software KC
            </div>';
          }
          ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Lab Praktikum Komputasional Cerdas - Data Software |||
                      <?php
                    ...
                    ?>
                                ...
                                <a style="float:right; color:blue" href="data_software_KC_form_tambah_data.php">Tambah Data |</a> 
                                 <a style="float:right; color:blue" href="function/KC_software_expor.php">Export Data |</a> 
                </div>
                    ...
                    $sql = mysql_query('SELECT * FROM data_software_kc');
                    $no = 1;
                    ...
                    <tr align='left'>
                        ...
                        <td>
                            <a href="data_software_KC_lihat.php?id1=<?php echo $r['id'];?>">Lihat</a> | 
                            <a href="data_software_KC_edit.php?id2=<?php echo $r['id'];?>">Edit</a> |
							             <a href="function/KC_delete_data_software.php?id3=<?php echo $r['id'];?>"
