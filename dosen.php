...
if (isset($_POST['user'])) {
  ...
  $MM_redirectLoginSuccess = "data/dosen/jadwal.php";
  $MM_redirectLoginFailed = "dosen.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_Labformatic, $Labformatic);
  
  $LoginRS__query=sprintf("SELECT username, password FROM `dosen` WHERE username=%s AND password=%s",
...
<html >
  <head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="asset/login/css/style_dosen.css">
    <link rel="stylesheet" href="asset/login/css/style_dosen.css">
...
<body onload="updateClock(); setInterval('updateClock()', 1000 );scrlsts();">
  ...
  <div class="login">
      ...
      <form ACTION="<?php echo $loginFormAction; ?>" style="margin-top:4px;" method="POST" name="logindosen">
